...
List<PaletteCommand> paletteCommands({
  ...
  required VoidCallback openSettings,
    ...
    [
      PaletteCommand('Save project', () => app.engine('Save')),
      PaletteCommand('Undo', () => app.engine('Undo')),
      PaletteCommand('Redo', () => app.engine('Redo')),
      PaletteCommand('New project', () => app.engine('New project')),
      PaletteCommand('Open project…', () => app.engine('Open project')),
      PaletteCommand('Import footage…', () => app.engine('Import footage')),
      PaletteCommand('New composition', () => app.engine('New composition')),
