...
**K-126 · DECIDED · Depth of field gains depth invert, separate near/far blur, and Display views
...
worktree. *Numbering risk:* chosen as the next free entry after K-125, but a concurrent effects
worktree also appends here — renumber on merge if K-126 collides.
