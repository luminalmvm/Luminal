...
flowchart TD
  ...
  subgraph SSPINE["Render and evaluation spine"]
    WPOOL["Worker pool<br/>(cores−1, interactive/background; 05 §2)"]
    SEAMS["Eval trait seams<br/>FrameSource / KernelExecutor / CacheStore (05 §1.1)"]
    PIXPASS["Eval-graph pixel pass —<br/>the graph renders, not lumit-ui (06 §1.1)"]
